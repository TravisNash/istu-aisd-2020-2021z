...
namespace BubbleSort
{
    class Program
    {
        ...
        public static void Bubble_Sort(int[] anArray)
        {
            ...
            {
                //Вложенный цикл (количество повторений, равно количеству элементов массива - 1 и - количество выполненных повторений основного цикла)
        ...
        //Вспомогательный метод который меняет два элемента местами
